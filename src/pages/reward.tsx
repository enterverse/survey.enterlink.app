...
function NavLink({
	...
	return (
		<Link
			to={to ? `?p=${to}` : ""}
			className={cn(
				"text-2xl font-semibold text-neutral-400 focus-visible:outline-none pb-1 focus-visible:ring-4 focus-visible:ring-neutral-50",
...
function RewardArea({
	...
	const InjectMeOwO = {
		...
		chars: <Characteristics personality={personality} />,
		compt: (
	...
	return (
		<div className="flex w-full max-w-4xl flex-col gap-8">
			...
			<ShareButton className="mx-auto" href={window.location.href} />
			<div className="h-px w-full bg-neutral-800" />
			<nav className="flex w-full flex-row gap-4 overflow-x-auto text-2xl font-semibold text-neutral-400 scrollbar-none *:shrink-0">
				<NavLink default>About You</NavLink>
				<NavLink to="stats">Stats</NavLink>
				<NavLink to="chars">Characteristics</NavLink>
		...
		<div className="flex flex-col gap-1">
			<div className="flex flex-row items-center gap-2 text-neutral-400">
				...
				<div className="relative h-5 w-full overflow-hidden rounded-full bg-neutral-800">
					<div
						className={cn(
							"absolute top-0 h-5 rounded-full bg-pink",
							leftHigher
		...
		<div className="flex flex-col gap-6">
			...
			<article className="prose prose-neutral prose-invert w-full max-w-4xl prose-headings:font-medium">
				...
				<p>
					...
					aligned with a particular profile, differing by just one trait, which
					offers a strong foundation for understanding, collaboration, and
					affinity.
				</p>
			</article>
